...
@Repository
@Slf4j
public class NineAxisMotionSensorFrameDao
        implements DaoBaseInsert<NineAxisMotionSensorFrame>, DaoBaseGet<NineAxisMotionSensorFrame> {
    ...
    @Override
    public Class<NineAxisMotionSensorFrame> getClazz() {
        return NineAxisMotionSensorFrame.class;
    }
