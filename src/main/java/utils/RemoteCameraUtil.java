...
//        FFmpegFrameGrabber.tryLoad();
    ...
    public static void main(String[] args) throws Exception, InterruptedException, SerialCustomException {
       RemoteCameraUtil remoteCameraUtil = new RemoteCameraUtil();
//       remoteCameraUtil.init("rtsp://127.0.0.1:1234/facetime", 2);
        remoteCameraUtil.init("0", 2);

       remoteCameraUtil.testCamera();
    }
